    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e0d] via-[#0d1410] to-[#0a0e0d] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Comece a monitorar criptomoedas</p>
        </div>
        ...
        <div className="bg-[#0f1914]/60 backdrop-blur-xl rounded-2xl border border-[#00ff88]/20 p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-gray-300 font-medium mb-2 text-sm">Nome</label>
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs mt-2">Mínimo de 6 caracteres</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              Já tem conta?{' '}
              <Link to="/login" className="text-[#00ff88] font-semibold hover:underline">
                Entre
              </Link>
            </p>
          </div>
